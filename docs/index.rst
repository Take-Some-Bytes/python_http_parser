...
.. _`body`: https://github.com/Take-Some-Bytes/python_http_parser/blob/v0.4.2/docs/modules/body.rst
.. _`constants`: https://github.com/Take-Some-Bytes/python_http_parser/blob/v0.4.2/docs/modules/constants.rst
.. _`errors`: https://github.com/Take-Some-Bytes/python_http_parser/blob/v0.4.2/docs/modules/errors.rst
.. _`stream`: https://github.com/Take-Some-Bytes/python_http_parser/blob/v0.4.2/docs/modules/stream.rst

.. _here: https://github.com/Take-Some-Bytes/python_http_parser/blob/v0.4.2/docs/modules/constants.rst#parser-strictness-constants
